...
// Build a function to build the table
...
function updateFilters() {
    ...
    // If filter value was entered then add that filteredId and value
    ...
    // Call the function to apply all filters and rebuild the table 
    filterTable();
}
